...
class GenerateSolverFrame(object):
    ...
    def generate_settings_frame(self):
        ...
        self.label_solver_select = ttk.Label(self.frame_solver_select,
                                             text='Select Solver')
        self.label_solver_select.grid(row=0, column=0, padx=10, pady=5,
                                      sticky='e')
        ...
        self.label_conv_crit = ttk.Label(self.master,
        ...
        # maximum iterations
        self.label_max_iterations = ttk.Label(self.master,
                                              text='Max # of Iterations')
        self.label_max_iterations.grid(row=2, column=0, padx=10, pady=2,
                                       sticky='e')
        ...
        self.label_relax_param = ttk.Label(self.master,
                                           text='Relaxation Parameter')
        self.label_relax_param.grid(row=3, column=0, padx=10, pady=2,
                                    sticky='e')
