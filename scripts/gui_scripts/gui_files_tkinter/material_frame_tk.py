...
class GenerateMaterialFrame(object):
    ...
    def material_property_frame(self):
        ...
        self.frame_material_name.grid(
            row=0, column=0, columnspan=3, padx=5, pady=5, ipadx=2, ipady=2,
            sticky='w')

        # ################ Density
        self.label_density = ttk.Label(self.master, text='Density')
        self.label_density.grid(row=1, column=0, padx=10, pady=2, sticky='e')
        self.entry_density = ttk.Entry(
            self.master, textvariable=self.material_density, justify='center')
        ...
        # ################## Specific Heat
        self.label_sp_heat = ttk.Label(
            self.master, text='Specific Heat', width=20, anchor='e')
        self.label_sp_heat.grid(row=1, column=3, padx=15, pady=2, sticky='e')
        self.entry_sp_heat = ttk.Entry(
            self.master, textvariable=self.material_sp_heat, justify='center')
        ...
        self.label_conductivity = ttk.Label(
            self.master, text='Thermal Conductivity')
        self.label_conductivity.grid(
            row=2, column=0, padx=10, pady=2, sticky='e')
        self.entry_conductivity = ttk.Entry(
            self.master, textvariable=self.material_conductivity,
            justify='center')
        ...
        # ################## Melting Point
        self.label_melt_point = ttk.Label(
            self.master, text='Melting Point', width=20, anchor='e')
        self.label_melt_point.grid(row=2, column=3, padx=15, pady=2, sticky='e')
        self.entry_melt_point = ttk.Entry(
            self.master, textvariable=self.material_melt_point,
            justify='center')
        ...
        self.entry_emissivity = ttk.Entry(
            self.master, textvariable=self.material_emissivity,
            justify='center')
        ...
        # ################## reflectivity
        self.label_reflectivity = ttk.Label(
            self.master, text='Reflectivity', width=20, anchor='e')
        self.label_reflectivity.grid(
            row=3, column=3, padx=15, pady=2, sticky='e')
        self.entry_reflectivity = ttk.Entry(
            self.master, textvariable=self.material_reflectivity,
            justify='center')
        ...
        self.label_material_name = ttk.Label(
            self.frame_material_name, text='Select Material')
        self.label_material_name.grid(
            row=0, column=0, padx=10, pady=5, sticky='e')

        self.combo_material_name = ttk.Combobox(
            self.frame_material_name, postcommand=self.return_material_list,
            width=30)
        self.combo_material_name.bind(
            "<<ComboboxSelected>>", self.new_material_selected)
    ...
    def enter_material_frame(self):
        self.button_add_material = ttk.Button(
            self.master, text='Add Material', command=self.add_material_to_db)
        self.button_add_material.grid(
            row=4, column=3, padx=5, pady=25, sticky='s')

        self.button_edit_material = ttk.Button(
            self.master, text='Edit Material', command=self.edit_material_in_db)
        self.button_edit_material.grid(
            row=4, column=4, padx=5, pady=25, sticky='s')

        self.button_close_window = ttk.Button(
            self.master, text='Close', command=self.master.destroy)
        self.button_close_window.grid(
            row=4, column=5, padx=5, pady=25, sticky='s')
