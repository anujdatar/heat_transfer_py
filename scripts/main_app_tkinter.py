...
from scripts.gui_scripts import GenerateMaterialFrame
from scripts.gui_scripts import GenerateProcessFrame
from scripts.gui_scripts import GenerateSolverFrame
