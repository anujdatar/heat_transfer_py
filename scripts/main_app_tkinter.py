...
from scripts.gui_files_tkinter import GenerateMaterialFrame
from scripts.gui_files_tkinter import GenerateProcessFrame
from scripts.gui_files_tkinter import GenerateSolverFrame
...
class MainAppTk(object):
    def __init__(self, master=None):
        ...
        self.material_frame = GenerateMaterialFrame('select',
                                                    self.frame_material)
    ...
    def generate_menu(self):
        ...
        self.edit_menu.add_command(label='Add/Edit Material',
    ...
    def launch_new_material_window(self):
        ...
        self.new_material_window = GenerateMaterialFrame('entry',
                                                         self.topbox_new_material)
